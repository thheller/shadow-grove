...
(def test-articles
  [{:description "It's about CONDUIT" :epoch 1574598956325, :slug "article-title-conduit-ixlsfw", :updatedAt "2019-11-24T12:35:56.325Z", :createdAt "2019-11-24T12:35:56.325Z", :title "ARTICLE TITLE - CONDUIT", :author {:username "jack37", :bio nil, :image "https://static.productionready.io/images/smiley-cyrus.jpg", :following false}, :favoritesCount 0, :body "Here's the MARKDOWN.", :favorited false, :tagList []}
   ...
   {:description "ee", :epoch 1574596585172, :slug "ewd-r4402h", :updatedAt "2019-11-24T11:56:25.172Z", :createdAt "2019-11-24T11:56:25.172Z", :title "ewd", :author {:username "ayushiB", :bio nil, :image "https://static.productionready.io/images/smiley-cyrus.jpg", :following false}, :favoritesCount 0, :body "ee", :favorited false, :tagList []}
   ...
   {:description "r", :epoch 1574598814651, :slug "r-9fdrdq", :updatedAt "2019-11-24T12:33:34.651Z", :createdAt "2019-11-24T12:33:34.651Z", :title "r", :author {:username "lia", :bio "xcZCzxc", :image "https://static.productionready.io/images/smiley-cyrus.jpg", :following false}, :favoritesCount 0, :body "r", :favorited false, :tagList []}])
